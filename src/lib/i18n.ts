...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'customers.phones': { en: 'Phones', he: 'טלפונים' },
  'customers.add_phone': { en: 'Add phone', he: 'הוסף טלפון' },
  'customers.no_phones': { en: 'No phones yet', he: 'אין טלפונים' },
  ...
  'settings.catalog': { en: 'Bread Catalog', he: 'קטלוג לחמים' },
  'settings.manage_catalog': { en: 'Manage Bread Catalog', he: 'ניהול קטלוג לחמים' },
  'settings.global_sizes': { en: 'Sizes Catalog', he: 'קטלוג גדלים' },
  'settings.is_default': { en: 'Default', he: 'ברירת מחדל' },
  'settings.is_default_hint': { en: 'Auto-enable for new bread types', he: 'הפעלה אוטומטית בסוגי לחם חדשים' },
  'settings.enabled_sizes': { en: 'Sizes for this type', he: 'גדלים לסוג זה' },
  'settings.price_override': { en: 'Override price', he: 'החלף מחיר' },
  'settings.no_enabled_sizes': { en: 'No sizes enabled — pick at least one', he: 'לא הופעלו גדלים — בחר/י לפחות אחד' },
  ...
  'reminder.sent': { en: 'Reminder sent', he: 'תזכורת נשלחה' },
  'reminder.send_failed': { en: 'Failed to send reminder', he: 'שליחת תזכורת נכשלה' },
  'reminder.sending': { en: 'Sending…', he: '…שולח' },
  'reminder.bulk_confirm_title': { en: 'Send Reminders', he: 'שליחת תזכורות' },
  'reminder.bulk_confirm_body': { en: 'Send a WhatsApp reminder to {count} customers?', he: 'לשלוח תזכורת בוואטסאפ ל־{count} לקוחות?' },
  'reminder.bulk_result': { en: 'Sent to {sent} of {total}', he: 'נשלחו {sent} מתוך {total}' },
  'reminder.no_eligible': { en: 'No customers with phone numbers', he: 'אין לקוחות עם מספר טלפון' },
