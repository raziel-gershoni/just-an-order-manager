...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.recipe': { en: 'Recipe', he: 'מתכון' },
  'settings.set_recipe': { en: 'Set recipe', he: 'הגדר מתכון' },
  'settings.no_recipe': { en: 'No recipe configured', he: 'אין מתכון מוגדר' },
  'settings.reference_weight': { en: 'Reference finished weight (g)', he: '(משקל ייחוס סופי (גרם' },
  'settings.dough_total': { en: 'Dough total', he: 'סך בצק' },
  'settings.finished_weight': { en: 'Finished weight', he: 'משקל סופי' },
  'settings.show_in_grams': { en: 'Show in grams for…', he: '…הצג בגרמים עבור' },
  'settings.bakers_pct': { en: "Baker's %", he: 'אחוזי אופה' },
  'settings.ingredient': { en: 'Ingredient', he: 'רכיב' },
  'settings.ingredient_kind': { en: 'Kind', he: 'סוג' },
  'settings.add_ingredient': { en: 'Add ingredient', he: 'הוסף רכיב' },
  'settings.grams': { en: 'Grams', he: 'גרם' },
  'settings.percent': { en: 'Percent', he: 'אחוז' },
  'settings.kind_flour': { en: 'Flour', he: 'קמח' },
  'settings.kind_water': { en: 'Water', he: 'מים' },
  'settings.kind_salt': { en: 'Salt', he: 'מלח' },
  'settings.kind_starter': { en: 'Starter', he: 'מחמצת' },
  'settings.kind_other': { en: 'Other', he: 'אחר' },
  'settings.recipe_save_failed': { en: 'Failed to save recipe', he: 'שמירת המתכון נכשלה' },
  'settings.recipe_no_flour': { en: 'Recipe must include at least one flour', he: 'המתכון חייב לכלול לפחות קמח אחד' },
  'settings.recipe_delete_confirm': { en: 'Delete this recipe?', he: '?למחוק את המתכון' },

  // Baker page
  'nav.baker': { en: 'Baker', he: 'אופה' },
  'baker.title': { en: 'Baker', he: 'אופה' },
  'baker.date': { en: 'Date', he: 'תאריך' },
  'baker.no_orders': { en: 'No orders for this date', he: 'אין הזמנות לתאריך זה' },
  'baker.loaves': { en: 'loaves', he: 'כיכרות' },
  'baker.total_flour': { en: 'Total flour', he: 'סך קמח' },
  'baker.total_dough': { en: 'Total dough', he: 'סך בצק' },
  'baker.expected_finished': { en: 'Expected finished weight', he: 'משקל סופי צפוי' },
  'baker.unconfigured_recipe': { en: 'Recipe not configured', he: 'מתכון לא מוגדר' },
  'baker.show_recipe': { en: 'Show recipe', he: 'הצג מתכון' },
  'baker.hide_recipe': { en: 'Hide recipe', he: 'הסתר מתכון' },
  'baker.by_size': { en: 'By size', he: 'לפי גודל' },
  'baker.recipe_block_title': { en: "Today's recipe", he: 'מתכון להיום' },
